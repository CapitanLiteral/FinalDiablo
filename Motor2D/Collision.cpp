...
Collision::Collision() : Module()
{
	...
	matrix[COLLIDER_PLAYER][COLLIDER_NPC] = false;
	...
	matrix[COLLIDER_NPC][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_NPC][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_NPC][COLLIDER_PLAYER_PARTICLE] = false;
	matrix[COLLIDER_NPC][COLLIDER_ENEMY_PARTICLE] = false;
